...
;(function($) {
	$.cookiesDirective = function(options) {
		...
		var settings = $.extend({
			...
			message: null,				
			cookieScripts: null,
			privacyPolicyUri: '/it/privacy.html',
			scriptWrapper: function(){},	
			// Styling
			fontFamily: 'helvetica',
			fontColor: '#FFFFFF',
			fontSize: '13px',
			backgroundColor: '#08305e',
			//backgroundOpacity: '0',
			linkColor: '#c8b67f', 
	...
	var disclosure = function(options) {
		...
		if(settings.explicitConsent) {
			...
			html += '<div style="margin-top:5px;"><input style="margin-top:5px; background-color: #232323;border: hidden;color: #fff; padding: 5px;" type="submit" name="impliedsubmit" id="impliedsubmit" value="' + settings.buttonText + '"/></div></div>';	
		}		
		html += '</div></div>';
		$('body').append(html);
